  ...
  return (
    <footer className="bg-black text-white mt-10">
      <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Logo & Deskripsi */}
        <div>
          <h2 className="text-2xl font-bold text-white mb-2">Nurul Iman</h2>
          <p className="text-gray-400 text-sm">
            Nurul Iman terus berusaha membangun Ummat dan Mensejahterakan
            Masyarakat.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-gray-400 text-sm">
            ...
            <li className="flex items-center gap-2">
              ...
              <a
                href="https://instagram.com/nuruliman"
                target="_blank"
      ...
      <div className="text-center text-gray-500 text-xs py-4 border-t border-gray-800">
        &copy; {new Date().getFullYear()} Nurul Iman. All rights reserved.
      </div>
    </footer>
  );
};
